...
public class SwaggerConfig {
    private static final String BASE_PACKAGE = "one.digitalinnovation.beershop.controller";
    ...
    private static final String CONTACT_GITHUB = "https://gtihub.com/Andremachado82";
